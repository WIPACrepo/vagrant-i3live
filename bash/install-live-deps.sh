...
pip install Django==1.4 MySQL-python South argparse colorama fabric lxml nose numpy==1.9.1 ordereddict pep8==0.6.1 pyephem pycrypto pymongo==2.7.2 python-twitter simplejson conttest textile toolz python-memcached scipy==0.14.0 django_redis==3.8
EOF
